const navigation = {
  ...
  social: [
    {
      name: "Linkedin",
      href: "https://www.linkedin.com/in/kiranacascade/",
      icon: (props) => (
        <svg width="24px" height="24px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
          <path
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/anacascade/",
      icon: (props) => (
    ...
    {
      name: "GitHub",
      href: "https://github.com/kiranacascade",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
  ...
  return (
    <section id="contact" className="bg-white">
      <div className="mx-auto max-w-7xl overflow-hidden py-20 px-6 sm:py-24 lg:px-8">
        ...
        <p className="mt-16 text-center text-xs leading-5 text-gray-500">Copyright &copy; 2023 by Kirana Devita Cascade.</p>
      </div>
    </section>
  );
}
